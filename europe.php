...
<html>
    ...
    <head>
        ...
        <script src="mapa/ammap/ammap.js" type="text/javascript"></script> 
		    <script src="mapa/ammap/maps/js/worldHigh.js" type="text/javascript"></script>
        <script> 
...
$sql = "SELECT nome, icao, cidade, lat, log FROM aeroportos";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) { 
        ...
        echo $row["log"];
        echo ', scale: 0.4'; 
        echo ', url: "aero.php?icao='. $row["icao"].'"},'; 
    }
} else { 
    echo 'error';
} 
